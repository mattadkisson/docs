...
This guide introduces the real-time rules capabilities introduced in SmartSpace version 3.5.
...
rules](/images/Ubisense%20Real%20Time%20Rules.png)
...
engine](/images/Ubisense%20Real%20Time%20Rules_1.png)
...
Because cellular rules and event handlers are executed in the cellular property data service, and site level properties cannot be set from the cellular property data service (see above for an explanation of why), it can be deduced that site level properties cannot be set by cellular rules and
event handlers.
...
![Ubisense Real Time Rules 2](/images/Ubisense%20Real%20Time%20Rules_2_270x262.png)

The default choice is to create properties in the site-level service (which was previously the only choice in earlier versions of the system). When created, the properties are annotated with their attribute (assertion,
cellular or blank for the traditional style of property):

![Ubisense Real Time Rules 3](/images/Ubisense%20Real%20Time%20Rules_3_412x148.png)
...
![Ubisense Real Time Rules 4](/images/Ubisense%20Real%20Time%20Rules_4_458x302.png)
...
![Ubisense Real Time Rules Step 5](/images/Ubisense%20Real%20Time%20Rules_5_462x298.png)
...
![Ubisense Real Time Rules Step 6](/images/Ubisense%20Real%20Time%20Rules_6_470x329.png)
...
![](/images/Ubisense%20Real%20Time%20Rules_7_467x342.png)
