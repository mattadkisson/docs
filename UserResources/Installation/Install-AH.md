...
# Ubisense Migration Guide for ACS 2.6  \+ Series 7000
...
Use the following instructions to migrate ACS 2.6 with Series 7000 to
SmartSpace + Series7000 + ACS.
...
order they should be carried out:
  ...
  10. Install the Series 7000 packages.
  11. Install the ACS packages.
  12. Continue with the migration using ubisense_smartspace_migration_helper.
  13. Remove empty folders from the dataset (optional).
  14. Run the ubisense_acs_monitor_spatial_relations tool.
  15. Download software to client machines.
  16. Install ACS text translations and audit translations.
  17. Run the client software.
  18. Configure Security Manager.
  19. Restrict audit messages for automated processes.
  20. If required, install SmartSpace Web for Windows or Linux.
