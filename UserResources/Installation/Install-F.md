...
# Ubisense Installation Guide for SmartSpace + DIMENSION4 with Site connector

A SmartSpace + DIMENSION4 installation includes the core Ubisense software and
any licensed SmartSpace features alongside DIMENSION4's tag location
capabilities.
...
subsequent sections take you through installing SmartSpace + DIMENSION4 with
Site connector step by step.
...
(SmartSpace Config , Location System Config ), you will need access to a
