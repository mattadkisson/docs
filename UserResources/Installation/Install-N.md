...
#  Ubisense Installation Guide for SmartSpace + DIMENSION4 + ACS with Site
connector
...
with Site connector step by step.
...
DIMENSION4 Backwards Compatibility with ACS by installing and deploying
additional services.
...
event of a fatal failure, you can write a cron script such as this one:
  ...
  * Ubisense Installation Guide for SmartSpace + DIMENSION4 + ACS with Site connector
  * The Ubisense installation process
  * Requirements
    * Server Hardware Requirements
    * Server Software Requirements
