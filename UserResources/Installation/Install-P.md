...
Series7000 + ACS with Site connector step by step.
...
SmartSpace + DIMENSION4 + Series7000 + ACS with Site connector installation.
...
event of a fatal failure, you can write a cron script such as this one:
  ...
  * Ubisense Installation Guide for SmartSpace + DIMENSION4 + Series7000 + ACS with Site connector
  * The Ubisense installation process
  * Requirements
    * Server Hardware Requirements
    * Server Software Requirements
