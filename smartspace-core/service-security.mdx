...
description: Multi-level role-based access control for the basic Ubisense services
keywords: service security, role-based access control, SmartSpace, Ubisense
---
