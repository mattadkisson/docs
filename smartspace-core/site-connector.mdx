...
description: Connect Ubisense platforms on separate networks using TCP/IP, either for multi-site operation, or for support purposes
keywords: site connector, ubisense, smartspace, core
---
