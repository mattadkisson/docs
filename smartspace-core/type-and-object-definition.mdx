---
Title: Type and Object Definition
Description: Tools and a framework to build and manage application-specific data models including types, objects, names, and spatial properties
keywords: types, objects, names, spatial properties, data modeling
---

![web of blocks with smaller blocks illustrating inheritance](../images/TypeAndObjectDefinition.jpg)
